                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="Enter brand name" name="name" value="{{ $brand->name }}" required>
                                </div>
                            </div>
                            <div class="form-group row">
                        ...
                        <div class="card-body">
                            <div class="clearfix">
                                <div class="form-group">
                                    <input type="file" class="dropify" name="image" data-default-file="{{ $brand->getFirstMediaUrl('brand') }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_visible1" name="is_visible" class="form-check-input" value="1" {{ check_uncheck($brand->is_visible,1) }}>
                                        <label class="form-check-label" for="is_visible1">Show</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_visible2" name="is_visible" class="form-check-input" value="0" {{ check_uncheck($brand->is_visible,0) }}>
                                        <label class="form-check-label" for="is_visible2">Hide</label>
                                    </div>
                                </div>

                                <div class="col-sm-12 mb-3">
                                    <label class="form-label mb-3 d-flex">Popular brand</label>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_popular1" name="is_popular" class="form-check-input" value="1" {{ check_uncheck($brand->is_popular,1) }}>
                                        <label class="form-check-label" for="is_popular1">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_popular2" name="is_popular" class="form-check-input" value="0" {{ check_uncheck($brand->is_popular,0) }}>
                                        <label class="form-check-label" for="is_popular2">No</label>
                                    </div>
                                </div>

                                <div class="col-sm-12 mb-3">
                                    <label class="form-label mb-3 d-flex">Special brand</label>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_special1" name="is_special" class="form-check-input" value="1" {{ check_uncheck($brand->is_special,1) }}>
                                        <label class="form-check-label" for="is_special1">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_special2" name="is_special" class="form-check-input" value="0" {{ check_uncheck($brand->is_special,0) }}>
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_home1" name="is_home" class="form-check-input" value="1" {{ check_uncheck($brand->is_home,1) }}>
                                        <label class="form-check-label" for="is_home1">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_home2" name="is_home" class="form-check-input" value="0" {{ check_uncheck($brand->is_home,0) }}>
                                ...
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_menu1" name="is_menu" class="form-check-input" value="1" {{ check_uncheck($brand->is_menu,1) }}>
                                        <label class="form-check-label" for="is_menu1">Yes</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_menu2" name="is_menu" class="form-check-input" value="0" {{ check_uncheck($brand->is_menu,0) }}>
