                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="Enter Offer name" name="name" value="{{ old('name') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control summernote" name="description" rows="4" placeholder="Enter offer details">{{ old('description') }}</textarea>
                                </div>
                            </div>

                            <div class="form-group row">
                                <label class="col-md-3 col-form-label">Benefits (JSON or Key-Value)</label>
                                <div class="col-md-9">
                                    <textarea class="form-control" name="benefits" rows="4" placeholder='e.g. {"discount": "10%", "min_order": "1000"}'>{{ old('benefits') }}</textarea>
