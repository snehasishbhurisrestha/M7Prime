                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" class="form-control" placeholder="Enter page name" name="name" value="{{ old('name') }}" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea rows="3" class="form-control" placeholder="Enter Meta Description" name="meta_description">{{ old('meta_description') }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
