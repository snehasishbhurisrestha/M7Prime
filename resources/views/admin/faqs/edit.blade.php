        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <input type="text" name="question" class="form-control" placeholder="Enter question" value="{{ old('question', $faq->question) }}" required>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <textarea name="answer" class="form-control summernote" rows="5" placeholder="Enter answer">{{ old('answer', $faq->answer) }}</textarea>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Update & Publish</h3>
                        </div>
                        <div class="card-body">
                            <div class="row clearfix">
                                <div class="col-sm-12 mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_visible1" name="is_visible" class="form-check-input" value="1" {{ old('is_visible', $faq->is_visible) == 1 ? 'checked' : '' }}>
                                        <label class="form-check-label" for="is_visible1">Show</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input type="radio" id="is_visible2" name="is_visible" class="form-check-input" value="0" {{ old('is_visible', $faq->is_visible) == 0 ? 'checked' : '' }}>
